...
Designing interface for better saving habits          </h1>
          <p className="text-xl text-zinc-400 font-light leading-relaxed">
            Designing interface for better saving habits
          </p>
        </header>
        ...
        <div className="my-8 p-12  text-center text-zinc-500 text-sm rounded-lg">
            <img
            src='/portfolio-pieces/project-1-image-1.webp'           
          />
        </div>

        <div className="my-8 p-12  text-center text-zinc-500 text-sm rounded-lg">
            <img
            src='/portfolio-pieces/project-1-image-2.webp'           
          />
        </div>

         <div className="my-8 p-12  text-center text-zinc-500 text-sm rounded-lg">
            <img
            src='/portfolio-pieces/project-1-image-3.webp'           
          />
        </div>
        ...
        <section className="space-y-6">
          ...
          <div className="my-8 p-12 border border-zinc-800 bg-zinc-900/40 text-center text-zinc-500 text-sm rounded-lg">
            [ Image: Pipeline Before vs. After Comparison Table ]
          </div>
        </section>
